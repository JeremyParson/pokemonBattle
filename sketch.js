...
function setup () { // Setup game ui
  window.addEventListener('keypress', function (event) { // Enebles enter to got to nect turn
    if (event.keyCode == 13) {
      setTimeout(function () {
...
function randomNumber (MaxInt) { //This was never used ;-;
...
// @Do not edit
function mouseClicked () {//Responsible for declaring actions
  if (pHealth[0] != 0) {
...
// @Do not edit
function turnStart (userAttack) {//does all teh damage calculation
  ...
  turn = true
  setTimeout(function () {//Cool stuff
    enemyTurn()
  }, 2000)
}
// @Do not edit
function announcement (announce) {//the announcer
  fill(255)
  textFont('Arial')
...
function enemyTurn () {//enemy turn damage calculations
